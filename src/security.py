...
#Dicionário "Mockando" os dados do banco de dados
db_clientes_api = {
    "abc": {
        "username": "abc",
        "full_name": "Abc dos Testes",
        "email": "abc@example.com",
        "password": "$2a$12$DmR9/WEXtnFp8oiuMHmk5OBenosEIQDm9L7wuO5B.3Y.pcxncIfZ6",
        "disabled": False,
    },
        "bolinhas": {
        "username": "bolinhas",
...
#Classes modelo para as requisições
...
#Rotas para geração e recuperação do token
